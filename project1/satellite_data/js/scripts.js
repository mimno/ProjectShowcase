...
d3.json("dataset.json", function(error, data) {
    ...
    var parentCoord = d3.select("#circle > svg").node().getBoundingClientRect();
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var circleX = circleCoord.left + (circleCoord.width / 2) - parentCoord.left;
        var circleY = circleCoord.bottom - (circleCoord.height / 2);
        var rectX = rectCoord.right - (rectCoord.width / 2) - parentCoord.left;
        var rectY = rectCoord.bottom - (rectCoord.height / 2);
